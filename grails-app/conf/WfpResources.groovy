modules = {
	wfp {
		dependsOn 'dialog,dialog-tree,dialog-dataTables,dialog-altselect,dialog-codemirror,bootstrap-responsive-css,bootstrap-tooltip,bootstrap-popover,bootstrap-modal,dialog-bootstrap,dialog-fileuploader'		
