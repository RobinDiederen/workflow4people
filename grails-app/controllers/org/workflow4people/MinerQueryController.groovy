...
class MinerQueryController {
    ...
    def jsonlist = {
    	render listService.jsonlist(MinerQuery,params,request) as JSON	
    }

	def dialog = { return dialogService.edit(MinerQuery,params) }
	
	def submitdialog = { render dialogService.submit(MinerQuery,params) as JSON }
	
	def delete = { render dialogService.delete(MinerQuery,params) as JSON }
