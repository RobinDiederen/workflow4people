...
<html>
    <head>
        ...
        <title><g:message code="authority.edit.title" /></title>
    </head>
    <body>
        ...
        <div class="body">
                    ...
                    <div class="nav">
                		...
                		<span class="menuButton"><g:link params="${filteredParams ? filteredParams : ''}" class="awesome small blue button" action="list">&laquo;&nbsp;<g:message code="authority.list.label" args="[entityName]" /></g:link></span>
