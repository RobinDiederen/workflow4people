                    ...
                    <tbody>
                        ...
                        <tr class=" nullprop">
                            ...
                            <!-- p=org.codehaus.groovy.grails.commons.DefaultGrailsDomainClassProperty@1161fded[name=name,type=class java.lang.String,persistent=true,optional=false,association=false,bidirectional=false,association-type=<null>] cp=org.codehaus.groovy.grails.validation.ConstrainedProperty@3865db85[class org.workflow4people.FieldList,name,class java.lang.String,{nullable=org.codehaus.groovy.grails.validation.NullableConstraint@272f15b0[false]}] -->
