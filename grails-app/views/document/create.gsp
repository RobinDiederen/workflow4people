...
<html>
    <head>
        ...
        <title><g:message code="document.create.title" /></title>
    </head>
    <body>
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop null">
                                ...
                                <td valign="top" class="value null ${hasErrors(bean: documentInstance, field: 'documentType', 'errors')}">
                            ...
                            <tr class="prop null">
                                ...
                                <td valign="top" class="value null ${hasErrors(bean: documentInstance, field: 'documentStatus', 'errors')}">
                            ...
                            <tr class="prop null">
                                ...
                                <td valign="top" class="value null ${hasErrors(bean: documentInstance, field: 'documentKey', 'errors')}">
                            ...
                            <tr class="prop null">
                                ...
                                <td valign="top" class="value null ${hasErrors(bean: documentInstance, field: 'dateCreated', 'errors')}">
                            ...
                            <tr class="prop null">
                                ...
                                <td valign="top" class="value null ${hasErrors(bean: documentInstance, field: 'lastUpdated', 'errors')}">
                            ...
                            <tr class="prop null">
                                ...
                                <td valign="top" class="value null ${hasErrors(bean: documentInstance, field: 'completionDate', 'errors')}">
                            ...
                            <tr class="prop null">
                                ...
                                <td valign="top" class="value null ${hasErrors(bean: documentInstance, field: 'processingDays', 'errors')}">
                            ...
                            <tr class="prop null">
                                ...
                                <td valign="top" class="value null ${hasErrors(bean: documentInstance, field: 'user', 'errors')}">
                            ...
                            <tr class="prop null">
                                ...
                                <td valign="top" class="value null ${hasErrors(bean: documentInstance, field: 'groupId', 'errors')}">
