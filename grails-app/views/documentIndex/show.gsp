...
<html>
    <head>
        ...
        <title><g:message code="documentIndex.show.title" /></title>
    </head>
    <body>
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${documentIndexInstance.name}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${documentIndexInstance.value}</td>
