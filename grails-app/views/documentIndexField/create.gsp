...
<html>
    <head>
        ...
        <title><g:message code="documentIndexField.create.title" /></title>
    </head>
    <body>
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop null">
                                ...
                                <td valign="top" class="value null ${hasErrors(bean: documentIndexFieldInstance, field: 'description', 'errors')}">
                            ...
                            <tr class="prop null">
                                ...
                                <td valign="top" class="value null ${hasErrors(bean: documentIndexFieldInstance, field: 'publish', 'errors')}">
