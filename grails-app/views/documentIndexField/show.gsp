...
<html>
    <head>
        ...
        <title><g:message code="documentIndexField.show.title" /></title>
    </head>
    <body>
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop extrawide">
                            ...
                            <td valign="top" class="value extrawide">${documentIndexFieldInstance.name}</td>
                        ...
                        <tr class="prop extrawide">
                            ...
                            <td valign="top" class="value extrawide">${documentIndexFieldInstance.title}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${documentIndexFieldInstance.description}</td>
                        ...
                        <tr class="prop extrawide">
                            ...
                            <td valign="top" class="value extrawide">${documentIndexFieldInstance.xpath}</td>
