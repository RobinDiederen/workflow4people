<wf:form title="Document type" width="950px">
	<wf:table>		                            
		...
		<wf:select multiple="true" class="multiselect" optionKey="id" object="${documentTypeInstance}" from="${org.workflow4people.DocumentIndexField.list(sort:'name')}" propertyName="documentIndexField" mode="edit" />
