...
<html>
    <head>
        ...
        <title><g:message code="holiday.create.title" /></title>
    </head>
    <body>
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop null">
                                ...
                                <td valign="top" class="value null ${hasErrors(bean: holidayInstance, field: 'fromDate', 'errors')}">
                            ...
                            <tr class="prop null">
                                ...
                                <td valign="top" class="value null ${hasErrors(bean: holidayInstance, field: 'toDate', 'errors')}">
