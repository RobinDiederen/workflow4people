<wf:form title="Namespace" width="835px" object="${namespaceInstance}">
	<wf:table>		                            
		...
		<wf:select multiple="true" class="altselect" optionKey="id" object="${namespaceInstance}" from="${org.workflow4people.Namespace.list(sort:'prefix')}" propertyName="importSchema" mode="edit"/>			               		        	    		
	</wf:table>		
</wf:form>
