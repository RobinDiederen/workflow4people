...
<html>
    <head>
        ...
        <title><g:message code="person.create.title" /></title>
    </head>
    <body>
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop null">
                                ...
                                <td valign="top" class="value null ${hasErrors(bean: personInstance, field: 'emailShow', 'errors')}">
                            ...
                            <tr class="prop null">
                                ...
                                <td valign="top" class="value null ${hasErrors(bean: personInstance, field: 'enabled', 'errors')}">
                            ...
                            <tr class="prop null">
                                ...
                                <td valign="top" class="value null ${hasErrors(bean: personInstance, field: 'description', 'errors')}">
