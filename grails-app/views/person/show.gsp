    ...
    <body>
        ...
        <div class="body">
            ...
            <div class="nav">
                		...
                		<span class="menuButton"><g:link  params="${filteredParams}" class="awesome small blue button" action="list">&laquo;&nbsp;<g:message code="person.list.label" args="[entityName]" /></g:link></span>
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop wide">
                            ...
                            <td valign="top" class="value wide">${personInstance.username}</td>
                        ...
                        <tr class="prop wide">
                            ...
                            <td valign="top" class="value wide">${personInstance.userRealName}</td>
                        ...
                        <tr class="prop wide">
                            ...
                            <td valign="top" class="value wide">${personInstance.familyName}</td>
                        ...
                        <tr class="prop wide">
                            ...
                            <td valign="top" class="value wide">${personInstance.givenName}</td>
                        ...
                        <tr class="prop wide">
                            ...
                            <td valign="top" class="value wide">${personInstance.email}</td>
                        ...
                        <tr class="prop wide">
                            ...
                            <td valign="top" class="value wide">${personInstance.passwd}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${personInstance.description}</td>
