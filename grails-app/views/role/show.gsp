    ...
    <body>
        ...
        <div class="body">
            ...
            <div class="nav">
                		...
                		<span class="menuButton"><g:link params="${filteredParams ? filteredParams : ''}" class="awesome small blue button" action="list">&laquo;&nbsp;<g:message code="role.list.label" args="[entityName]" /></g:link></span>
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop wide">
                            ...
                            <td valign="top" class="value wide">${roleInstance.name}</td>
                        ...
                        <tr class="prop wide">
                            ...
                            <td valign="top" class="value wide">${roleInstance.title}</td>
                        ...
                        <tr class="prop wide">
                            ...
                            <td valign="top" class="value wide">${roleInstance.description}</td>
